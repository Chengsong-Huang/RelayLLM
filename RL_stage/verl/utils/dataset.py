...
class RLHFDataset(Dataset):
    ...
    def _filter_overlong_prompts(self, example: dict[str, Any]) -> bool:
        ...
        if self.image_key in example:
            prompt = self.processor.apply_chat_template(messages, add_generation_prompt=True, tokenize=False, enable_thinking=False)
            ...
            input_ids = self.tokenizer.apply_chat_template(messages, add_generation_prompt=True, enable_thinking=False, tokenize=False)
